...
const Header = () => {
    ...
    useEffect(() => {
        ...
        Animated.sequence([// Pop notification badge
    ...
    return (<View className="bg-white rounded-b-[60px] h-[135px] relative mb-6">
            {/* Header row */}
            ...
            <Animated.View
                ...
                className='absolute -bottom-14 z-10  left-4'
            >
                <View className="mx-6 mb-4 rounded-2xl">
                    ...
                    >
                        <View className="p-4">
                            <Text
                                className="text-primary-700 text-sm font-medium italic leading-6 ml-3 border-l-2 border-primary-300 pl-3">
