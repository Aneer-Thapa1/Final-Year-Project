                    ...
                    <View className="bg-theme-card-dark/90 backdrop-blur-xl rounded-3xl p-6 shadow-card-dark">
                        ...
                        <View className="mb-4">
                            <View className={`flex-row items-center bg-theme-input-dark rounded-2xl px-4 border ${
                                errors.name ? 'border-error-500' : 'border-theme-border-dark'
                            }`}>
                        ...
                        {/* Gender Selection */}
                        <View className="mb-6">
                            <View className={`bg-theme-input-dark rounded-2xl px-4 border ${
                                errors.gender ? 'border-error-500' : 'border-theme-border-dark'
                            }`}>
                                <Picker
