...
<Image  source={images.logo} className='mt-10 w-12 h-12'/>
    <Text className='text-white text-4xl font-montserrat-extrabold text-center'>Sign in to your {'\n'} Account</Text>
    <Text className='text-white'>Enter your email and password to log in </Text>
</View>
    ...
    <View style={{ position: 'absolute', backgroundColor: 'white', top: '30%', left: '50%', width: '83.33%', height: 'fit',  borderRadius: '20px', transform: [{ translateX: '-50%' }] }}>
        <View className="flex-1 justify-center p-4 gap-6">
            ...
            <Text className='font-montserrat-light text-base'> Remember me</Text>
            <Text className='font-montserrat-light text-primary-300'> Forgot Password?</Text>
            </View>
            ...
            <Text className='text-center'>Don't have an account? <Text className='text-primary-300'> <Link href='/sign-up'>Sign Up</Link>  </Text> </Text>
        </View>
    </View>
